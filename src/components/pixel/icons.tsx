...
import {
  ...
  Info as LucideInfo,
  TriangleAlert as LucideWarning,
  OctagonAlert as LucideError,
  Flame as LucideFlame,
  Snowflake as LucideSnowflake,
  Expand as LucideExpand,
} from "lucide-react";

function usePrefersLucide(): boolean {
  const { data } = useSettings();
  return data?.pixelFontEnabled === false;
}

export const Home: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideHome {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
...
export const Calendar: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideCalendar {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const Sliders: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideSliders {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const SaveIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideSave {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const EditIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucidePencil {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const CloseIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide) return <LucideX {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const ChevronLeftIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideChevronLeft {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const ChevronRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideChevronRight {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const CheckIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideCheck {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const PlusIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucidePlus {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const TrashIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideTrash {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const ChevronDownIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideChevronDown {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const ChevronUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideChevronUp {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const IceIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideSnowflake {...props} className={cn(props.className)} />;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideFlame {...props} className={cn(props.className)} />;
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const InfoIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideInfo {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const WarningIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideWarning {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const ErrorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => {
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideError {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
...
export const FullScreenIcon: React.FC<React.SVGProps<SVGSVGElement>> = (
  ...
  const useLucide = usePrefersLucide();
  if (useLucide)
    return <LucideExpand {...props} className={cn(props.className)} />;
  return (
    <svg
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
