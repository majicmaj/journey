...
export const THEME_PRESETS: ThemePreset[] = [
  ...
  },
  {
    ...
    dark: false,
    varsLight: {
      background: "oklch(1 0 210)",
      card: "oklch(0.97 0 210)",
      foreground: "oklch(0 0 220)",
      primary: "oklch(0 0 210)",
      "primary-foreground": "oklch(0.98 0 0)",
      secondary: "oklch(0.6 0 220)",
      "secondary-foreground": "oklch(0.98 0 0)",
      border: "oklch(0.8 0 210)",
    },
    varsDark: {
      background: "oklch(0 0 210)",
      card: "oklch(0.2 0 210)",
      foreground: "oklch(0.98 0 0)",
      primary: "oklch(1 0 210)",
      "primary-foreground": "oklch(0 0 0)",
      secondary: "oklch(0.6 0 220)",
      "secondary-foreground": "oklch(0.98 0 0)",
      border: "oklch(0.3 0 210)",
    },
  },
];
